...
var index_1 = require("../../../../ts-gsm-modem/dist/lib/index");
var ChanDongleConfManager_1 = require("./lib/ChanDongleConfManager");
var Tty0tty_1 = require("./lib/Tty0tty");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    portVirtual = new index_1.SerialPortExt(voidModem.leftEnd, {
                        "baudRate": 115200,
                        "parser": index_1.SerialPortExt.parsers.readline("\r")
                    });
                    ...
                    portVirtual.on("data", function (buff) {
                        ...
                        modem.runCommand(command, {
                            "recoverable": true,
                            "reportMode": index_1.AtMessage.ReportMode.NO_DEBUG_INFO,
                            "retryOnErrors": false
