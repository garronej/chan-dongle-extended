...
var ami = ts_ami_1.Ami.localhost({ user: _chan_dongle_extended_client_1.amiUser });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    _a.label = 2;
                case 2:
                    ami.userEvent(_chan_dongle_extended_client_1.Event.NewActiveDongle.build(imei, modem.iccid, modem.imsi, modem.number || "", modem.serviceProviderName || ""));
                    imsi = modem.imsi;
                    dongleIdentifier = {
                        "name": dongleName,
                        "number": modem.number || "",
                    ...
                    modem.evtMessageStatusReport.attach(function (statusReport) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            ...
                            ami.userEvent(_chan_dongle_extended_client_1.Event.MessageStatusReport.build(imei, "" + messageId, isNaN(dischargeTime.getTime()) ? "" + dischargeTime : dischargeTime.toISOString(), isDelivered ? "true" : "false", status, recipient));
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    ami.userEvent(_chan_dongle_extended_client_1.Event.NewMessage.build(imei, number, date.toISOString(), text));
...
main_1.activeModems.evtDelete.attach(function (_a) {
    ...
    return ami.userEvent(_chan_dongle_extended_client_1.Event.ActiveDongleDisconnect.build(modem.imei, modem.iccid, modem.imsi, modem.number || "", modem.serviceProviderName || ""));
});
            ...
            switch (_a.label) {
                case 0:
                    evtDisconnect.attachOnce(function () {
                        ami.userEvent(_chan_dongle_extended_client_1.Event.LockedDongleDisconnect.build(imei, iccid, pinState, "" + tryLeft));
                ...
                case 1:
                    ...
                    if (pin && pinState === "SIM PIN" && tryLeft === 3) {
                        ...
                        ami.userEvent(_chan_dongle_extended_client_1.Event.RequestUnlockCode.build(imei, iccid, pinState, "" + tryLeft));
                    return [2 /*return*/];
            }
        });
    });
});
ami.evtUserEvent.attach(_chan_dongle_extended_client_1.Request.match, function (evtRequest) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_o) {
        switch (_o.label) {
            case 0:
                ...
                replyError = function (errorMessage) { return ami.userEvent(_chan_dongle_extended_client_1.Response.build(actionid, errorMessage)); };
                if (!_chan_dongle_extended_client_1.Request.SendMessage.match(evtRequest)) return [3 /*break*/, 2];
                ...
                text = _chan_dongle_extended_client_1.Request.SendMessage.reassembleText(evtRequest);
                return [4 /*yield*/, modem.sendMessage(evtRequest.number, text)];
            case 1:
                messageId = _o.sent();
                if (isNaN(messageId))
                    return [2 /*return*/, replyError("Message not send")];
                ami.userEvent(_chan_dongle_extended_client_1.Response.SendMessage.build(actionid, "" + messageId));
                return [3 /*break*/, 56];
            case 2:
                if (!_chan_dongle_extended_client_1.Request.UpdateNumber.match(evtRequest)) return [3 /*break*/, 4];
            ...
            case 3:
                _o.sent();
                ami.userEvent(_chan_dongle_extended_client_1.Response.build(actionid));
                ...
                return [3 /*break*/, 56];
            case 4:
                if (!_chan_dongle_extended_client_1.Request.GetLockedDongles.match(evtRequest)) return [3 /*break*/, 14];
                return [4 /*yield*/, ami.userEvent(_chan_dongle_extended_client_1.Response.GetLockedDongles_first.build(actionid, "" + main_1.lockedModems.size))];
            case 5:
                _o.sent();
                _o.label = 6;
            case 6:
            ...
            case 7:
                ...
                return [4 /*yield*/, ami.userEvent(_chan_dongle_extended_client_1.Response.GetLockedDongles_follow.build(actionid, imei, iccid, pinState, "" + tryLeft))];
            case 8:
                _o.sent();
                _o.label = 9;
            case 9:
            ...
            case 14:
                if (!_chan_dongle_extended_client_1.Request.GetMessages.match(evtRequest)) return [3 /*break*/, 25];
                if (!main_1.activeModems.has(evtRequest.imei))
                    return [2 /*return*/, replyError("Dongle imei: " + evtRequest.imei + " not found")];
            ...
            case 15:
                ...
                appData.release();
                return [4 /*yield*/, ami.userEvent(_chan_dongle_extended_client_1.Response.GetMessages_first.build(actionid, "" + messages.length))];
            case 16:
                _o.sent();
                _o.label = 17;
            case 17:
            ...
            case 18:
                ...
                return [4 /*yield*/, ami.userEvent(_chan_dongle_extended_client_1.Response.GetMessages_follow.build(actionid, number, date.toISOString(), text))];
            case 19:
                _o.sent();
                _o.label = 20;
            case 20:
            ...
            case 25:
                if (!_chan_dongle_extended_client_1.Request.GetSimPhonebook.match(evtRequest)) return [3 /*break*/, 35];
                if (!main_1.activeModems.has(evtRequest.imei))
                    return [2 /*return*/, replyError("Dongle imei: " + evtRequest.imei + " not found")];
                modem = main_1.activeModems.get(evtRequest.imei).modem;
                contacts = modem.contacts;
                return [4 /*yield*/, ami.userEvent(_chan_dongle_extended_client_1.Response.GetSimPhonebook_first.build(actionid, "" + modem.contactNameMaxLength, "" + modem.numberMaxLength, "" + modem.storageLeft, "" + contacts.length))];
            case 26:
                _o.sent();
                _o.label = 27;
            case 27:
            ...
            case 28:
                ...
                return [4 /*yield*/, ami.userEvent(_chan_dongle_extended_client_1.Response.GetSimPhonebook_follow.build(actionid, "" + index, name, number))];
            case 29:
                _o.sent();
                _o.label = 30;
            case 30:
            ...
            case 35:
                if (!_chan_dongle_extended_client_1.Request.CreateContact.match(evtRequest)) return [3 /*break*/, 38];
                if (!main_1.activeModems.has(evtRequest.imei))
                    return [2 /*return*/, replyError("Dongle imei: " + evtRequest.imei + " not found")];
                modem = main_1.activeModems.get(evtRequest.imei).modem;
            ...
            case 36:
                contact = _o.sent();
                return [4 /*yield*/, ami.userEvent(_chan_dongle_extended_client_1.Response.CreateContact.build(actionid, "" + contact.index, contact.name, contact.number))];
            case 37:
                _o.sent();
                return [3 /*break*/, 56];
            case 38:
                if (!_chan_dongle_extended_client_1.Request.DeleteContact.match(evtRequest)) return [3 /*break*/, 41];
                if (!main_1.activeModems.has(evtRequest.imei))
                    return [2 /*return*/, replyError("Dongle imei: " + evtRequest.imei + " not found")];
                modem = main_1.activeModems.get(evtRequest.imei).modem;
            ...
            case 39:
                _o.sent();
                return [4 /*yield*/, ami.userEvent(_chan_dongle_extended_client_1.Response.build(actionid))];
            case 40:
                _o.sent();
                return [3 /*break*/, 56];
            case 41:
                if (!_chan_dongle_extended_client_1.Request.GetActiveDongles.match(evtRequest)) return [3 /*break*/, 51];
                return [4 /*yield*/, ami.userEvent(_chan_dongle_extended_client_1.Response.GetActiveDongles_first.build(actionid, "" + main_1.activeModems.size))];
            case 42:
                _o.sent();
                _o.label = 43;
            case 43:
            ...
            case 44:
                ...
                return [4 /*yield*/, ami.userEvent(_chan_dongle_extended_client_1.Response.GetActiveDongles_follow.build(actionid, imei, iccid, imsi, number || "", serviceProviderName || ""))];
            case 45:
                _o.sent();
                _o.label = 46;
            case 46:
            ...
            case 51:
                if (!_chan_dongle_extended_client_1.Request.UnlockDongle.match(evtRequest)) return [3 /*break*/, 53];
                imei = evtRequest.imei;
            ...
            case 52:
                ...
                return [3 /*break*/, 56];
            case 53:
                if (!_chan_dongle_extended_client_1.Request.GetConfig.match(evtRequest)) return [3 /*break*/, 55];
                return [4 /*yield*/, ami.userEvent(_chan_dongle_extended_client_1.Response.GetConfig.build(actionid, chanDongleConfManager_1.chanDongleConfManager.getConfig()))];
            case 54:
                _o.sent();
                return [3 /*break*/, 56];
