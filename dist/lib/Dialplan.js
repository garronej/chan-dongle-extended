...
var Dialplan;
(function (Dialplan) {
    Dialplan.amiClient = null;
    function notifyStatusReport(dongle, statusReport) {
        return __awaiter(this, void 0, void 0, function () {
            var name, number, provider, imei, imsi, assignations, dischargeTime, isDelivered, messageId, status;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, assignAndRun(assignations, smsStatusReportExtension)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Dialplan.notifyStatusReport = notifyStatusReport;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, assignAndRun(assignations, smsExtension)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, addDialplanExtension(initExtension, priority++, "Answer()", dialplanContext)];
                    case 1:
                        _a.sent();
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, addDialplanExtension(initExtension, priority++, "Set(" + assignation + ")", dialplanContext)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
                        _i++;
                        return [3 /*break*/, 2];
                    case 5: return [4 /*yield*/, addDialplanExtension(initExtension, priority++, "GoTo(" + gotoExtension + ",1)", dialplanContext)];
                    case 6:
                        _a.sent();
