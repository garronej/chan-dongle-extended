...
var runInstaller = function () { return build_tarball_1.execSyncInherit(node_path + " " + path.join(bin_dir_path, "installer.js") + " install " + args); };
...
(function postinstall_node_python_messaging() {
    ...
    build_tarball_1.execSyncInherit("./install-python-dep.sh", { "cwd": node_python_messaging_dir_path });
})();
runInstaller();
